        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5 text-xs sm:text-sm">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-slate-200 dark:border-slate-800">
            <div>
              {onDelete && (
                confirmDelete ? (
                  <div className="flex items-center space-x-1.5 bg-rose-50 dark:bg-rose-950/60 p-1 rounded-xl border border-rose-200 dark:border-rose-900">
                    <span className="text-[11px] font-bold text-rose-700 dark:text-rose-300 px-1.5">정말 삭제할까요?</span>
                    <button
                      type="button"
                      onClick={() => {
                        onDelete(booking.id);
                    ...
                    <button
                      ...
                      className="px-2 py-1 rounded-lg bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-200 text-[11px] font-semibold hover:bg-slate-300 transition-colors cursor-pointer"
                    >
                      취소
                    </button>
                  </div>
                  ...
                  <button
                    ...
                    className="px-3 py-2 rounded-xl text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/60 border border-rose-200 dark:border-rose-900 text-xs font-bold flex items-center space-x-1 transition-colors cursor-pointer"
                    title="이 신청 내역 삭제"
                  >
                    <Trash2 className="w-3.5 h-3.5" />
                    <span>신청 내역 삭제</span>
